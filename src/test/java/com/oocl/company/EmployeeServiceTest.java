...
public class EmployeeServiceTest {
    ...
    public void should_return_size_3_when_add_3_employee_and_execute_findAllEmployees()
    {
        ...
        employeeService.add(new Employee(1,2,"小霞2", 15, "女",3000));
        employeeService.add(new Employee(1,3,"小霞3", 15, "女",3000));
    ...
    public void should_return_all_man_employee_when_findManEmployees(){
        employeeService = new EmployeeService();
        employeeService.add(new Employee(1,4,"小霞", 15, "女",3000));
        employeeService.add(new Employee(1,1,"小明", 15, "男",3000));
    ...
    public void should_return_the_size_is_one_when_Employees_is_3_page_2_pageSize_2(){
        employeeService = new EmployeeService();
        employeeService.add(new Employee(1,1,"小霞", 15, "女",3000));
        employeeService.add(new Employee(1,2,"小明", 15, "男",3000));
        employeeService.add(new Employee(1,3,"小李", 15, "男",3000));
